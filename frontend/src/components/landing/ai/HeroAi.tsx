...
const HeroAI=()=>{
    return(
        <div className="  w-full ">
            ...
            viewport={{once:true}}
            className="text-[8vw] font-semibold tracking-tighter px-10 pt-20  mb-10 leading-28">Meet Your <br /> Creative AI Companion</motion.h1>
            <motion.p 
             initial={{ y:-20,opacity:0 }}
            whileInView={{y:0,opacity:1 }}
            ...
            <div className="h-[105vh] py- 10 px-10 mb-30">
                ...
                viewport={{once:true}}
                 className="h-full w-full rounded-xl object-cover object-center" src="assets\ai.png" alt="" />
            </div>
        </div>
    )
}
